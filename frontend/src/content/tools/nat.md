...
short_description: About `ls` alternative with useful info and a splash of color 🎨
description: >-
  Why Natls?
  ...
  * A splash of color to distinguish between files and folders and other file
  types
repository_url: https://github.com/willdoescode/nat
author: Will
license: MIT
language: Rust
installation:
